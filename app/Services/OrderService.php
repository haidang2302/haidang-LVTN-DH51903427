...
class OrderService extends BaseService implements OrderServiceInterface 
{
    ...
    public function update($request){
        ...
        try{
            ...
            // Cập nhật đơn hàng với payload từ request
    ...
    /**
     * Tự động xác nhận đơn hàng ngay khi được tạo
     * 
     * @param int $orderId
     * @return bool
     */
    public function autoConfirmOrder($orderId){
        DB::beginTransaction();
        try{
            ...
            DB::rollBack();
            Log::error('Auto confirm order failed: ' . $e->getMessage());
            return false;
        }
    }
