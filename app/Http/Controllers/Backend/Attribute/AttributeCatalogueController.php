...
class AttributeCatalogueController extends Controller
{
    ...
    public function index(Request $request){
        ...
        $attributeCatalogues = $this->attributeCatalogueService->paginate($request, null);
        $config = [
            'js' => [
    ...
    public function store(StoreAttributeCatalogueRequest $request){
        if($this->attributeCatalogueService->create($request, null)){
    ...
    public function edit($id, Request $request){
        ...
        $attributeCatalogue = $this->attributeCatalogueRepository->getAttributeCatalogueById($id, null);
    ...
    public function update($id, UpdateAttributeCatalogueRequest $request){
        ...
        if($this->attributeCatalogueService->update($id, $request, null)){
    ...
    public function destroy(DeleteAttributeCatalogueRequest $request, $id){
        if($this->attributeCatalogueService->destroy($id, null)){
