...
<div class="panel-body mb30">
    @if (auth()->guard('customer')->check())
        <div class="cart-information">
            ...
            <div class="uk-grid uk-grid-medium mb20">
                ...
                <div class="uk-width-large-1-3">
                    <select name="district_id" id="" class="setupSelect2 districts location"
                        data-target="wards">
    ...
    @else
        <div class="cart-information">
            ...
            <div class="uk-grid uk-grid-medium mb20">
                <div class="uk-width-large-1-3">
                    <select required name="province_id" id="" class="province location setupSelect2"
                        data-target="districts">
                        <option value="0">[Chọn Thành Phố]</option>
                        @foreach ($provinces as $key => $val)
                            <option value="{{ $val->code }}">{{ $val->name }}</option>
                ...
                <div class="uk-width-large-1-3">
                    <select required name="district_id" id="" class="setupSelect2 districts location"
                        data-target="wards">
                        <option value="0">Chọn Quận Huyện</option>
                    </select>
                </div>
                <div class="uk-width-large-1-3">
                    <select required name="ward_id" id="" class="setupSelect2 wards">
                        <option value="0">Chọn Phường Xã</option>
                    </select>
                </div>
            </div>
